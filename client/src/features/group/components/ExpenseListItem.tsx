...
export const ExpenseListItem = ({
  ...
  switch(item.category) {
    case "FOOD": iconBgColor = "#FFF7ED"; iconColor = "#F97316"; break;
    case "TRANSPORT": iconBgColor = "#EFF6FF"; iconColor = "#3B82F6"; break;
    case "ENTERTAINMENT": iconBgColor = "#FAF5FF"; iconColor = "#A855F7"; break;
    case "HOUSING": iconBgColor = "#F0FDF4"; iconColor = "#22C55E"; break;
    case "TRAVEL": iconBgColor = "#FEF2F2"; iconColor = "#EF4444"; break;
    case "SHOPPING": iconBgColor = "#FDF2F8"; iconColor = "#EC4899"; break;
    case "HEALTH": iconBgColor = "#ECFEFF"; iconColor = "#06B6D4"; break;
    case "EDUCATION": iconBgColor = "#FFFBEB"; iconColor = "#F59E0B"; break;
    case "PETS": iconBgColor = "#F5F3FF"; iconColor = "#8B5CF6"; break;
    case "GIFTS": iconBgColor = "#FFF1F2"; iconColor = "#F43F5E"; break;
    case "OTHER": iconBgColor = "#F3F4F6"; iconColor = "#6B7280"; break;
    default: break;
  }
  ...
  if (item.splits && item.splits.length > 0) {
    const totalSplitAmount = item.splits.reduce((sum: number, split: any) => sum + parseFloat(split.amount || "0"), 0);
        ...
        <View className="flex-row items-start justify-between">
          <View className="flex-row items-center gap-3">
            ...
            <View className="flex-col">
              ...
              >
                {formatCurrency(item.amount)} · {item.paidById === currentUserId ? "Bạn trả" : `${item.paidBy} trả`}
              </Text>
            </View>
          </View>
