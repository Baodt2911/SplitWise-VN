 ...
 */
export const getMemberInitials = (name: string | undefined | null) => {
 ...
 */
export const getMemberAvatarColor = (id: string | undefined | null) => {
  const colors = [
    "#E1BEE7",
    "#C8E6C9",
    "#BBDEFB",
 ...
 */
export const getMemberTextColor = (id: string | undefined | null) => {
  const colors = [
    "#7B1FA2",
    "#388E3C",
    "#1976D2",
